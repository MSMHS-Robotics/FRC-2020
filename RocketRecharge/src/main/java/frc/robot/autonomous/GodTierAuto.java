    ...
    */
    public GodTierAuto(Drivetrain drivetrain, Intake intake, Shooter shooter) {
        super(
            ...
            new TurnOnHeading(drivetrain, 90, 10.5), // turn right 
            new SetDrive(drivetrain, 90, 0.4, 96, 5), // drive toward opponent trench
            new SetDrive(drivetrain, 90, 0, 0, 0.1), // stop
            new TurnOnHeading(drivetrain, 0, 2), // turn torward trench
            new RunIntakeCommand(intake, 0.5), // start intake
            new SetDrive(drivetrain, 0, 0.4, 36, 2), // drive to steal power cells
            new SetDrive(drivetrain, 0, 0, 0, 0.1), // stop
            new RunIntakeCommand(intake, 0), // stop intake
            new SetDrive(drivetrain, 0, -0.4, 36, 2), // drive out of trench
            new SetDrive(drivetrain, 0, 0, 0, 0.1), // stop
            new TurnOnHeading(drivetrain, -90, 10.5), // turn 90 degrees left
            new WarmupCommand(shooter, null, 90, true, drivetrain), // start warmup
            new SetDrive(drivetrain, -90, 0.5, 36, 2), // drive towards goal
            new SetDrive(drivetrain, -90, 0, 0, 0.1), // stop
            ...
            new SetDrive(drivetrain, -90, 0.4, 60, 5), // drive toward alliance trench
            new SetDrive(drivetrain, -90, 0, 0, 0.1), // stop
            new TurnOnHeading(drivetrain, 0, 10.5), // turn to face trench
            new RunIntakeCommand(intake, 0.5), // run intake
            new SetDrive(drivetrain, 0, 0.4, 144, 10), // drive to pick up 5 power cells in trench
            new SetDrive(drivetrain, 0, 0, 0, 0.1), // stop
            new RunIntakeCommand(intake, 0), // stop intake
            new WarmupCommand(shooter, null, 0, true, drivetrain), // warmup
            new SetDrive(drivetrain, 0, -0.4, 144, 10), // drive backwards toward goal
            new SetDrive(drivetrain, 0, 0, 0, 0.1), // stop
            new TurnOnHeading(drivetrain, 135, 10.5), // turn to face goal
